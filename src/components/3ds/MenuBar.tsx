...
const menuItems: { label: string; access: string; items: MenuEntry[] }[] = [
  ...
  { label: 'Rendering', access: 'R', items: ['Render...', 'Render Setup...', 'Environment...', 'sep', 'Material Editor...', 'Material/Map Browser...', 'MapTools...', 'sep', 'WaltGame...', 'Run Game (F12)', 'Export HTML Game...', 'sep', 'View Image File...'] },
  ...
  { label: 'Help', access: 'H', items: ['User Reference', 'MAXScript Reference', 'Tutorials', 'Keyboard Shortcuts', 'What\'s New', 'sep', 'Welcome...', 'About Walt3D...'] },
];
