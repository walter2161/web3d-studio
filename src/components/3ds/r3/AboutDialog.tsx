...
export const AboutDialog = ({ open, onOpenChange }: Props) => (
  <R3Dialog open={open} onClose={() => onOpenChange(false)} title="About 3De" width={420}>
    <div className="flex gap-3">
      ...
      <div className="text-[11px] flex-1">
        <div className="font-bold">3De · Web Edition</div>
        <div className="mt-1">Version 3.0.1 · Build 2026.07</div>
        <div className="mt-2">Copyright © 2026 3de.app</div>
